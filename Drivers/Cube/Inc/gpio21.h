...
// 温度输入
#define ATin0_Pin           GPIO_PIN_0
#define ATin0_Port          GPIOA
...
// 2024/10/2 ok
#define ACout_nPassby_Pin    GPIO_PIN_8
#define ACout_nPassby_Port   GPIOC
...
#define ACout_Passby_State  ((ACout_nPassby_Port->IDR & ACout_nPassby_Pin)? 0 : 1)

// 逆变器工作允许控制
// Invertor enable control
// 2024/10/2 ok
#define Invertor_En_Pin     GPIO_PIN_15
#define Invertor_En_Port    GPIOA
// 正逻辑
#define Invertor_ON         SetPinToHigh( Invertor_En_Port, Invertor_En_Pin )
#define Invertor_OFF        SetPinToLow ( Invertor_En_Port, Invertor_En_Pin )
#define Invertor_State      ((Invertor_En_Port->ODR & Invertor_En_Pin)? 1 : 0)

// 风扇控制
// Device Fan control
// 取消380En，改FanCtrl
// 2024/10/2 ok
#define DevFanCtrl_Pin      GPIO_PIN_11
#define DevFanCtrl_Port     GPIOA
// 正逻辑
...
// 2024/10/2 ok
#define Adapter_ON_Pin      GPIO_PIN_7
...
// 逆变器辅助电源，即18V输出
// 2024/10/2 ok
#define Invertor5V_Pin      GPIO_PIN_12
#define Invertor5V_Port     GPIOA
// 正逻辑
