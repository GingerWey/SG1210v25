...
//-----------------------------------------------------------------------------
// 三次谐波  gcd(80,3)=1  period=80  uses DFT80P0..DFT80P19 (full table)
// 输入： pwSamples - 80个点的实部系列
// 输出： pfResult  - 保存结果的缓冲区，一个复数，实部、虚部
...
//------------------------
  fReal =
    DFT80P0  * ( (int) s[0]  - s[40] ) +
    DFT80P1  * ( (int) s[27] + s[53] - s[13] - s[67] ) +
    DFT80P2  * ( (int) s[26] + s[54] - s[14] - s[66] ) +
    DFT80P3  * ( (int) s[1]  + s[79] - s[39] - s[41] ) +
    DFT80P4  * ( (int) s[28] + s[52] - s[12] - s[68] ) +
    DFT80P5  * ( (int) s[25] + s[55] - s[15] - s[65] ) +
    DFT80P6  * ( (int) s[2]  + s[78] - s[38] - s[42] ) +
    DFT80P7  * ( (int) s[29] + s[51] - s[11] - s[69] ) +
    DFT80P8  * ( (int) s[24] + s[56] - s[16] - s[64] ) +
    DFT80P9  * ( (int) s[3]  + s[77] - s[37] - s[43] ) +
    DFT80P10 * ( (int) s[30] + s[50] - s[10] - s[70] ) +
    DFT80P11 * ( (int) s[23] + s[57] - s[17] - s[63] ) +
    DFT80P12 * ( (int) s[4]  + s[76] - s[36] - s[44] ) +
    DFT80P13 * ( (int) s[31] + s[49] - s[9]  - s[71] ) +
    DFT80P14 * ( (int) s[22] + s[58] - s[18] - s[62] ) +
    DFT80P15 * ( (int) s[5]  + s[75] - s[35] - s[45] ) +
    DFT80P16 * ( (int) s[32] + s[48] - s[8]  - s[72] ) +
    DFT80P17 * ( (int) s[21] + s[59] - s[19] - s[61] ) +
    DFT80P18 * ( (int) s[6]  + s[74] - s[34] - s[46] ) +
    DFT80P19 * ( (int) s[33] + s[47] - s[7]  - s[73] );
//------------------------
  fImage =
    DFT80P19 * ( (int) s[53] + s[67] - s[13] - s[27] ) +
    DFT80P18 * ( (int) s[14] + s[26] - s[54] - s[66] ) +
    DFT80P17 * ( (int) s[41] + s[79] - s[1]  - s[39] ) +
    DFT80P16 * ( (int) s[52] + s[68] - s[12] - s[28] ) +
    DFT80P15 * ( (int) s[15] + s[25] - s[55] - s[65] ) +
    DFT80P14 * ( (int) s[42] + s[78] - s[2]  - s[38] ) +
    DFT80P13 * ( (int) s[51] + s[69] - s[11] - s[29] ) +
    DFT80P12 * ( (int) s[16] + s[24] - s[56] - s[64] ) +
    DFT80P11 * ( (int) s[43] + s[77] - s[3]  - s[37] ) +
    DFT80P10 * ( (int) s[50] + s[70] - s[10] - s[30] ) +
    DFT80P9  * ( (int) s[17] + s[23] - s[57] - s[63] ) +
    DFT80P8  * ( (int) s[44] + s[76] - s[4]  - s[36] ) +
    DFT80P7  * ( (int) s[49] + s[71] - s[9]  - s[31] ) +
    DFT80P6  * ( (int) s[18] + s[22] - s[58] - s[62] ) +
    DFT80P5  * ( (int) s[45] + s[75] - s[5]  - s[35] ) +
    DFT80P4  * ( (int) s[48] + s[72] - s[8]  - s[32] ) +
    DFT80P3  * ( (int) s[19] + s[21] - s[59] - s[61] ) +
    DFT80P2  * ( (int) s[46] + s[74] - s[6]  - s[34] ) +
    DFT80P1  * ( (int) s[47] + s[73] - s[7]  - s[33] ) +
    DFT80P0  * ( (int) s[20] - s[60] );
...
//-----------------------------------------------------------------------------
// 四次谐波  gcd(80,4)=4  period=20  uses DFT80P0,P4,P8,P12,P16 (5 terms)
// 输入： pwSamples - 80个点的实部系列
// 输出： pfResult  - 保存结果的缓冲区，一个复数，实部、虚部
...
//------------------------
  fReal =
    DFT80P0  * ( (int) s[0]  + s[20] + s[40] + s[60]
               - s[10] - s[30] - s[50] - s[70] ) +
    DFT80P4  * ( (int) s[1]  + s[19] + s[21] + s[39] + s[41] + s[59] + s[61] + s[79]
               - s[9]  - s[11] - s[29] - s[31] - s[49] - s[51] - s[69] - s[71] ) +
    DFT80P8  * ( (int) s[2]  + s[18] + s[22] + s[38] + s[42] + s[58] + s[62] + s[78]
               - s[8]  - s[12] - s[28] - s[32] - s[48] - s[52] - s[68] - s[72] ) +
    DFT80P12 * ( (int) s[3]  + s[17] + s[23] + s[37] + s[43] + s[57] + s[63] + s[77]
               - s[7]  - s[13] - s[27] - s[33] - s[47] - s[53] - s[67] - s[73] ) +
    DFT80P16 * ( (int) s[4]  + s[16] + s[24] + s[36] + s[44] + s[56] + s[64] + s[76]
               - s[6]  - s[14] - s[26] - s[34] - s[46] - s[54] - s[66] - s[74] );
//------------------------
  fImage =
    DFT80P16 * ( (int) s[11] + s[19] + s[31] + s[39] + s[51] + s[59] + s[71] + s[79]
               - s[1]  - s[9]  - s[21] - s[29] - s[41] - s[49] - s[61] - s[69] ) +
    DFT80P12 * ( (int) s[12] + s[18] + s[32] + s[38] + s[52] + s[58] + s[72] + s[78]
               - s[2]  - s[8]  - s[22] - s[28] - s[42] - s[48] - s[62] - s[68] ) +
    DFT80P8  * ( (int) s[13] + s[17] + s[33] + s[37] + s[53] + s[57] + s[73] + s[77]
               - s[3]  - s[7]  - s[23] - s[27] - s[43] - s[47] - s[63] - s[67] ) +
    DFT80P4  * ( (int) s[14] + s[16] + s[34] + s[36] + s[54] + s[56] + s[74] + s[76]
               - s[4]  - s[6]  - s[24] - s[26] - s[44] - s[46] - s[64] - s[66] ) +
    DFT80P0  * ( (int) s[15] + s[35] + s[55] + s[75]
               - s[5]  - s[25] - s[45] - s[65] );
...
//-----------------------------------------------------------------------------
// 五次谐波  gcd(80,5)=5  period=16  uses DFT80P0,P5,P10,P15 (4 terms)
// 输入： pwSamples - 80个点的实部系列
// 输出： pfResult  - 保存结果的缓冲区，一个复数，实部、虚部
...
//------------------------
  fReal =
    DFT80P0  * ( (int) s[0]  + s[16] + s[32] + s[48] + s[64]
               - s[8]  - s[24] - s[40] - s[56] - s[72] ) +
    DFT80P5  * ( (int) s[1]  + s[15] + s[17] + s[31] + s[33] + s[47] + s[49] + s[63] + s[65] + s[79]
               - s[7]  - s[9]  - s[23] - s[25] - s[39] - s[41] - s[55] - s[57] - s[71] - s[73] ) +
    DFT80P10 * ( (int) s[2]  + s[14] + s[18] + s[30] + s[34] + s[46] + s[50] + s[62] + s[66] + s[78]
               - s[6]  - s[10] - s[22] - s[26] - s[38] - s[42] - s[54] - s[58] - s[70] - s[74] ) +
    DFT80P15 * ( (int) s[3]  + s[13] + s[19] + s[29] + s[35] + s[45] + s[51] + s[61] + s[67] + s[77]
               - s[5]  - s[11] - s[21] - s[27] - s[37] - s[43] - s[53] - s[59] - s[69] - s[75] );
//------------------------
  fImage =
    DFT80P15 * ( (int) s[9]  + s[15] + s[25] + s[31] + s[41] + s[47] + s[57] + s[63] + s[73] + s[79]
               - s[1]  - s[7]  - s[17] - s[23] - s[33] - s[39] - s[49] - s[55] - s[65] - s[71] ) +
    DFT80P10 * ( (int) s[10] + s[14] + s[26] + s[30] + s[42] + s[46] + s[58] + s[62] + s[74] + s[78]
               - s[2]  - s[6]  - s[18] - s[22] - s[34] - s[38] - s[50] - s[54] - s[66] - s[70] ) +
    DFT80P5  * ( (int) s[11] + s[13] + s[27] + s[29] + s[43] + s[45] + s[59] + s[61] + s[75] + s[77]
               - s[3]  - s[5]  - s[19] - s[21] - s[35] - s[37] - s[51] - s[53] - s[67] - s[69] ) +
    DFT80P0  * ( (int) s[12] + s[28] + s[44] + s[60] + s[76]
               - s[4]  - s[20] - s[36] - s[52] - s[68] );
