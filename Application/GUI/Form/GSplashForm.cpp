...
#define SP_MODEL_Y         60
#define SP_MODEL_W         300
#define SP_MODEL_H         40
...
static void _Redraw(void)
{
  ...
  GUI_DrawPicture(CSG_WINATLAS, 120, 180, picIdxMA_Logo80x20Cyan, 100);

  //GUI_DrawPicture(CSG_WINATLAS,  10, 10, picIdxMU_Item32x32_01, 100);
  //GUI_DrawPicture(CSG_WINATLAS,  60, 10, picIdxMU_Item32x32_02, 100);
  //GUI_DrawPicture(CSG_WINATLAS, 110, 10, picIdxMU_Item32x32_03, 100);
  //GUI_DrawPicture(CSG_WINATLAS, 160, 10, picIdxMU_Item32x32_04, 100);
  //GUI_DrawPicture(CSG_WINATLAS, 210, 10, picIdxMU_Item32x32_05, 100);
  //GUI_DrawPicture(CSG_WINATLAS, 260, 10, picIdxMU_Item32x32_06, 100);
}
...
//=============================================================================
// Form descriptor - exposed via GSplashForm.h
//=============================================================================
